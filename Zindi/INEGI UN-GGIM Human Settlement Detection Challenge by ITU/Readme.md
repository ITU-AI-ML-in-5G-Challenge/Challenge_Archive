...
Original on Zindi: https://zindi.africa/competitions/inegi-gcim-human-settlement-detection-challenge
...
### Evaluation
The evaluation metric for this challenge is the [Area Under the Curve](https://zindi.africa/learn/zindi-error-metric-series-how-to-use-area-under-curve-auc-as-an-evaluation-metric-for-machine-learning).
...
We reserve the right to update the contest timeline if necessary.essary.
