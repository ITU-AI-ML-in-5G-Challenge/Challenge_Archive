...
##  Can you predict daily solar energy generation and create optimal strategies for utilizing these energy sources?

Original on Zindi: https://zindi.africa/competitions/smart-energy-supply-scheduling-for-green-telecom
...
![fig](iaforgood.png)
<i>FFigure 1. Smart energy supply for green telecom.</i>
...
A CSV file named strategy.csv, that details the usage times for grid, solar, and diesel.
A comprehensive report explaining their solution, strategy and model outcomes.
The developed code that supports their findings and strategies.
...
There are 18 000 Zindi points available. You can read more about Zindi points [here](https://zindi.africa/discussions/13959?utm_source=zindi&utm_medium=blog&utm_campaign=challenge_resources&utm_id=CR).
